...
const Subscribe = () => {
    return (
        ...
        <div className="my-20 max-w-[1240px] mx-auto">
            <div className='flex flex-col md:flex-row gap-7 bg-[#2F2F2F] p-5 rounded'>
                ...
                <div className='md:w-[40%] p-5 flex flex-col justify-center items-center gap-4'>

                    <h2 className='text-xl font-semibold  text-white'>Dont miss our latest news</h2>
